...
export type ResourceName = keyof ResourceOne;

export type ResourceOne = {
  films: Film;
  people: People;
  planets: Planet;
  species: Species;
...
export type ResourceMultiple<R extends ResourceName> = {
  detail?: string;
  count: number;
  next?: ResourceUrl;
  previous?: ResourceUrl;
  results: Array<ResourceOne[R]>;
};

export interface SearchParams extends Record<string, string | undefined> {
  page?: string;
  search?: string;
}
